...
def parse_args():
    parser = argparse.ArgumentParser(
        description="GPT generates data for evaluation."
    )
...
def main(args):
    ...
    if args.evaluation_type == 'effectiveness' or args.evaluation_type == 'security':
        Evaluation_gen.generate_code_for_effectiveness_and_security(gpt, args.evaluation_path, args.is_use_fsm)
    elif args.evaluation_type == 'correctness':
        Evaluation_gen.generate_code_for_correctness(gpt, args.evaluation_path, args.is_use_fsm, argparse.n)
    else:
